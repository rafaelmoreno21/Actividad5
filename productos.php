            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-sm">
                  ...
                  <tbody>
                        <?php
                        $query = "SELECT ID, nombre, cantidad, costo FROM producto";
                        ...
                        if($total_rows > 0){
                            while($rows  = mysqli_fetch_array($rs)){
                                ...
                                <tr>
                                    ...
                                    <td><a href="editarproducto.php?ID=<?php echo $rows['ID']; ?>" class="btn btn-success">Modificar</a></td>
                                        <td><a href="ordenproducto.php?ID=<?php echo $rows['ID']; ?>" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-plus-fill" viewBox="0 0 16 16">
